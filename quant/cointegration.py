...
if __name__ == "__main__":
    ...
    print("Stationarity Test for Hero Motocorp Closing Prices")
    stationarity_test(actual_price2)
    
    
    plt.title("Closing prices of BAJAJAUTO and HEROMOTOCORP over past 5 years")
    ...
    cointegration_test(actual_price1, actual_price1)
