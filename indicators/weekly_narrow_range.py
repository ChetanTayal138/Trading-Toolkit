...
if __name__ == "__main__":
    ...
    for i in range(2,len(dates)):
        ...
        third_df = get_equities(f"../data/weekly_nse_200/{third_day_date}-{third_day_month}-2021.csv", list(NSE_200_SYMBOLS))
        second_df = get_equities(f"../data/weekly_nse_200/{second_day_date}-{second_day_month}-2021.csv", list(NSE_200_SYMBOLS))
        first_df = get_equities(f"../data/weekly_nse_200/{first_day_date}-{first_day_month}-2021.csv", list(NSE_200_SYMBOLS))
